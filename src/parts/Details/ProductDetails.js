  ...
  return (
    <section className="container mx-auto">
      <div className="flex flex-wrap my-4 md:my-12">
        {/* <!-- start: details title on mobile screen --> */}
        <div className="w-full md:hidden px-4">
          <h2 className="text-3xl font-semibold">Chair Thatty</h2>
          <span className="text-lg">IDR 12.000.000</span>
        </div>
        {/* <!-- end: details title on mobile screen --> */}

        {/* <!-- start: Flex Left - Image Preview & Thumbnail --> */}
        <div className="flex-1">
          <div className="slider">
            {/* <!-- start: Image thumbnail --> */}
            <div className="thumbnail">
              {/* <!-- start: image-thumbnail 1 --> */}
              <div className="px-2">
                <div
                ...
                >
                  <img
                    ...
                    alt="Chair Side Choices 1"
                    className="w-full h-full object-cover rounded-lg"
                  />
                </div>
              </div>
              {/* <!-- end: image-thumbnail 1 --> */}

              {/* <!-- start: image-thumbnail 2 --> */}
              <div className="px-2">
                <div
                  className="item"
                ...
                >
                  <img
                    ...
                    alt="Chair Side Choices 2"
                    className="w-full h-full object-cover rounded-lg"
                  />
                </div>
              </div>
              {/* <!-- end: image-thumbnail 2 --> */}

              {/* <!-- start: image-thumbnail 3 --> */}
              <div className="px-2">
                <div
                  className="item"
                ...
                >
                  <img
                    ...
                    alt="Chair Side Choices 3"
                    className="w-full h-full object-cover rounded-lg"
                  />
                </div>
              </div>
              {/* <!-- end: image-thumbnail 3 --> */}

              {/* <!-- start: image-thumbnail 4 --> */}
              <div className="px-2">
                <div
                  className="item"
                ...
                >
                  <img
                    ...
                    alt="Chair Side Choices 4"
                    className="w-full h-full object-cover rounded-lg"
                  />
                </div>
              </div>
              {/* <!-- end: image-thumbnail 4 --> */}

              {/* <!-- start: image-thumbnail 5 --> */}
              <div className="px-2">
                <div
                  className="item"
                ...
                >
                  <img
                    ...
                    alt="Chair Side Choices 5"
                    className="w-full h-full object-cover rounded-lg"
                  />
                </div>
              </div>
              {/* <!-- end: image-thumbnail 5 --> */}
            </div>
            {/* <!-- end: Image thumbnail --> */}
        ...
        {/* <!-- end: Flex Left - Image Preview & Thumbnail --> */}

        {/* <!-- start: Flex right - Image Description --> */}
        <div className="flex-1 px-4 md:p-6">
          <div className="hidden md:block">
            <h2 className="text-5xl font-semibold mb-3">Chair Thatty</h2>
        ...
        {/* <!-- end: Flex right - Image Description --> */}
      </div>
    </section>
  );
};
